...
class Person extends BaseModel {
	...
	public function scopeGlobalAttendance($query, $variable)
	{
		...
		$query =  $query->selectraw('persons.*')
					...
					->selectraw('sum((SELECT if(actual_status="HB",1,0) FROM attendance_logs WHERE attendance_logs.process_log_id = process_logs.id  and actual_status <> "L" and attendances_logs.deleted_at is null order by updated_at desc limit 1)) as HB')
					->selectraw('sum((SELECT if(actual_status="HC",if(modified_status="HT", 1, 0),0) FROM attendance_logs WHERE attendance_logs.process_log_id = process_logs.id  and actual_status <> "L" and attendances_logs.deleted_at is null order by updated_at desc limit 1)) as HT')
					->selectraw('sum((SELECT if(actual_status="HC",if(modified_status="HP", 1, 0),0) FROM attendance_logs WHERE attendance_logs.process_log_id = process_logs.id  and actual_status <> "L" and attendances_logs.deleted_at is null order by updated_at desc limit 1)) as HP')
					->selectraw('sum((SELECT if(actual_status="HC",if(modified_status="HD", 1, 0),0) FROM attendance_logs WHERE attendance_logs.process_log_id = process_logs.id  and actual_status <> "L" and attendances_logs.deleted_at is null order by updated_at desc limit 1)) as HD')
					->selectraw('sum((SELECT if(actual_status="HC",if(modified_status="HC", 1, if(modified_status="", 1, 0)),0) FROM attendance_logs WHERE attendance_logs.process_log_id = process_logs.id  and actual_status <> "L" and attendances_logs.deleted_at is null order by updated_at desc limit 1)) as HC')
					->selectraw('sum((SELECT if(actual_status="AS",if(modified_status="DN", 1, 0),0) FROM attendance_logs WHERE attendance_logs.process_log_id = process_logs.id  and actual_status <> "L" and attendances_logs.deleted_at is null order by updated_at desc limit 1)) as DN')
					->selectraw('sum((SELECT if(actual_status="AS",if(modified_status="SS", 1, 0),0) FROM attendance_logs WHERE attendance_logs.process_log_id = process_logs.id  and actual_status <> "L" and attendances_logs.deleted_at is null order by updated_at desc limit 1)) as SS')
					->selectraw('sum((SELECT if(actual_status="AS",if(modified_status="SL", 1, 0),0) FROM attendance_logs WHERE attendance_logs.process_log_id = process_logs.id  and actual_status <> "L" and attendances_logs.deleted_at is null order by updated_at desc limit 1)) as SL')
					->selectraw('sum((SELECT if(actual_status="AS",if(modified_status="CN", 1, 0),0) FROM attendance_logs WHERE attendance_logs.process_log_id = process_logs.id  and actual_status <> "L" and attendances_logs.deleted_at is null order by updated_at desc limit 1)) as CN')
					->selectraw('sum((SELECT if(actual_status="AS",if(modified_status="CB", 1, 0),0) FROM attendance_logs WHERE attendance_logs.process_log_id = process_logs.id  and actual_status <> "L" and attendances_logs.deleted_at is null order by updated_at desc limit 1)) as CB')
					->selectraw('sum((SELECT if(actual_status="AS",if(modified_status="CI", 1, 0),0) FROM attendance_logs WHERE attendance_logs.process_log_id = process_logs.id  and actual_status <> "L" and attendances_logs.deleted_at is null order by updated_at desc limit 1)) as CI')
					->selectraw('sum((SELECT if(actual_status="AS",if(modified_status="UL", 1, 0),0) FROM attendance_logs WHERE attendance_logs.process_log_id = process_logs.id  and actual_status <> "L" and attendances_logs.deleted_at is null order by updated_at desc limit 1)) as UL')
					->selectraw('sum((SELECT if(actual_status="AS",if(modified_status="AS", 1, if(modified_status="", 1, 0)),0) FROM attendance_logs WHERE attendance_logs.process_log_id = process_logs.id  and actual_status <> "L" and attendances_logs.deleted_at is null order by updated_at desc limit 1)) as `AS`')
					->selectraw('sum((SELECT if(modified_status="HC" || modified_status="AS" || modified_status="UL" || modified_status="SS" || modified_status="SL", if(margin_start<0, abs(margin_start), 0) + if(margin_end<0, abs(margin_end), 0), if(modified_status=0, if(actual_status="HC" || actual_status="AS" || actual_status="UL" || actual_status="SS" || actual_status="SL", if(margin_start<0, abs(margin_start), 0) + if(margin_end<0, abs(margin_end), 0), 0),0) ) FROM attendance_logs WHERE attendance_logs.process_log_id = process_logs.id  and actual_status <> "L" and attendances_logs.deleted_at is null order by updated_at desc limit 1)) as total_absence')
