...
class PersonObserver 
{
	public function saving($model)
	{
		...
		if ($validator->passes())
		{
			$validator 				= Validator::make($model['attributes'], ['uniqid' => 'unique:persons,uniqid,'.(isset($model['attributes']['id']) ? $model['attributes']['id'].'deleted_at,NULL' : 'deleted_at,NULL'), 'username' => 'unique:persons,username,'.(isset($model['attributes']['id']) ? $model['attributes']['id'].'deleted_at,NULL' : 'deleted_at,NULL')], ['uniqid.unique' => 'N I K sudah terpakai']);
