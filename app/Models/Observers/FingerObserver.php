...
class FingerObserver 
{
	...
	public function created($model)
	{
		...
		$attributes['name'] 				= 'Menambah Data Sidik Jari';
		$attributes['notes'] 				= 'Menambah Data Sidik Jari'.' pada '.date('d-m-Y');
	...
	public function updated($model)
	{
		$attributes['record_log_id'] 		= $model->id;
		$attributes['record_log_type'] 		= get_class($model);
		$attributes['name'] 				= 'Mengubah Data Sidik Jari ';
		$attributes['notes'] 				= 'Mengubah Data Sidik Jari '.' pada '.date('d-m-Y');
	...
	public function deleted($model)
	{
		$attributes['record_log_id'] 		= $model->id;
		$attributes['record_log_type'] 		= get_class($model);
		$attributes['name'] 				= 'Menghapus Data Sidik Jari';
		$attributes['notes'] 				= 'Menghapus Data Sidik Jari'.' pada '.date('d-m-Y');
