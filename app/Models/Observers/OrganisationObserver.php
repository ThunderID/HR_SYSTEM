...
class OrganisationObserver 
{
	...
	public function saving($model)
	{
		...
		if ($validator->passes())
		{
			$validator 			= Validator::make($model['attributes'], ['code' => 'unique:organisations,code,'.(isset($model['attributes']['id']) ? $model['attributes']['id'].'deleted_at,NULL' : 'deleted_at,NULL')], ['code.unique' => 'Kode sudah terpakai']);
