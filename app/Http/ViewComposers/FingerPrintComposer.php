...
class FingerPrintComposer extends WidgetComposer 
{
	...
	protected function setData($options)
	{
		...
		$results 								=  $this->dispatch(new Getting(new FingerPrint, $options['search'], $options['sort'] , (int)$options['page'], (int)$options['per_page'], isset($options['new']) ? $options['new'] : false));
