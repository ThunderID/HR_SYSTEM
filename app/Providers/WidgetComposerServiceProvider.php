...
class WidgetComposerServiceProvider extends ServiceProvider {
	...
	private function admin_widget()
	{
		...
		// CHARTWORKLEAVE
		// -----------------------------------------------------------------------------
		View::composer(['widgets.organisation.branch.chart.workleave.table', 'widgets.organisation.branch.chart.workleave.form', 'widgets.organisation.person.workleave.followworkleave'], 	'App\Http\ViewComposers\ChartWorkleaveComposer');
		...
		// IDLE LOG
		// -----------------------------------------------------------------------------
		View::composer(['widgets.common.personwidget.stat.stat_idle', 'widgets.common.personwidget.stat.stat_active', 'widgets.common.personwidget.table.table_idle'], 	'App\Http\ViewComposers\IdleLogComposer');
