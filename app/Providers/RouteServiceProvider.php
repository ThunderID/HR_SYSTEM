	...
	public function register()
	{
		...
		App::singleton('hr_acl', function()
		{
			$routes_acl = [
							...
							'hr.report.wages.index'							=> [['1', '2', '3', '4', '5'], 'read'],
							'hr.report.wages.show'							=> [['1', '2', '3', '4', '5'], 'read'],
							'hr.report.wages.create'						=> [['1', '2', '3'], 'create'],
							'hr.report.wages.store'							=> [['1', '2', '3'], 'create'],
							'hr.report.wages.edit'							=> [['1', '2', '3'], 'update'],
