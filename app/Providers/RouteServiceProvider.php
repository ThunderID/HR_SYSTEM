	...
	public function register()
	{
		...
		App::singleton('hr_acl', function()
		{
			$routes_acl = [
							...
							'hr.idles.index'								=> [['1'], 'read'],
							'hr.idles.show'									=> [['1'], 'read'],
							...
							'hr.branches.index'								=> [['1'], 'read'],
							'hr.branches.show'								=> [['1'], 'read'],
							...
							'hr.branch.contacts.index'						=> [['1'], 'read'],
							'hr.branch.contacts.show'						=> [['1'], 'read'],
							...
							'hr.branch.charts.index'						=> [['1'], 'read'],
							'hr.branch.charts.show'							=> [['1'], 'read'],
							...
							'hr.branch.fingers.index'						=> [['1','2'], 'read'],
							'hr.branch.fingers.show'						=> [['1','2'], 'read'],
							...
							'hr.chart.authentications.index'				=> [['1'], 'read'],
							'hr.chart.authentications.show'					=> [['1'], 'read'],
							...
							'hr.chart.calendars.index'						=> [['1','2'], 'read'],
							'hr.chart.calendars.show'						=> [['1','2'], 'read'],
							...
							'hr.chart.calendars.index'						=> [['1'], 'read'],
							'hr.chart.calendars.show'						=> [['1'], 'read'],
							'hr.chart.calendars.create'						=> [['1'], 'create'],
							'hr.chart.calendars.store'						=> [['1'], 'create'],
							'hr.chart.calendars.edit'						=> [['1'], 'update'],
							'hr.chart.calendars.update'						=> [['1'], 'update'],
							'hr.chart.calendars.delete'						=> [['1'], 'delete'],

							'hr.calendars.index'							=> [['1','2'], 'read'],
							'hr.calendars.show'								=> [['1','2'], 'read'],
							...
							'hr.calendar.schedules.index'					=> [['1','2'], 'read'],
							'hr.calendar.schedules.show'					=> [['1','2'], 'read'],
							...
							'hr.calendar.charts.index'						=> [['1','2'], 'read'],
							'hr.calendar.charts.show'						=> [['1','2'], 'read'],
							...
							'hr.documents.index'							=> [['1','2'], 'read'],
							'hr.documents.show'								=> [['1','2'], 'read'],
							...
							'hr.document.templates.index'					=> [['1','2'], 'read'],
							'hr.document.templates.show'					=> [['1','2'], 'read'],
