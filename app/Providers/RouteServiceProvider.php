	...
	public function register()
	{
		...
		App::singleton('hr_acl', function()
		{
			$routes_acl = [
							...
							'hr.attendance.persons.index'					=> 97,
							'hr.attendance.persons.show'					=> 97,
							'hr.attendance.persons.create'					=> 98,
							'hr.attendance.persons.store'					=> 98,
							'hr.attendance.persons.edit'					=> 99,
							'hr.attendance.persons.update'					=> 99,
							'hr.attendance.persons.delete'					=> 100,
