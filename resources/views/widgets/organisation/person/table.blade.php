						...
						<tr class="">
							...
							<td class="">
								@if ((File::exists($value['avatar']))&&(!$value['avatar']))
									{!! HTML::image($value['avatar'], '', array( 'width' => 64, 'height' => 64, 'class' => 'img-rounded' ), ['secure' => 'yes']) !!} 
								@else
									{!! HTML::image('/tmp_avatar.png', '', array( 'width' => 64, 'height' => 64, 'class' => 'img-rounded' ), ['secure' => 'yes']) !!} 
								@endif
							</td>
							<td class="">
								{{$value['name']}}
							...
							<td class="">
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-menu-right">
										...
										<li>
											<a href="{{route('hr.person.workleaves.index', ['person_id' => $value['id'], 'org_id' => $data['id']])}}" title="jatah cuti"><i class="fa fa-bed fa-fw"></i> Pengaturan Cuti</a>
										</li>
										<li>
