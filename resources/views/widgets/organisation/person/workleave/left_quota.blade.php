	...
	@section('widget_body')
		@if(isset($PersonComposer['widget_data']['personlist']['person']))
			<div class="alert alert-callout alert-info no-margin">
				...
				<h5>{{($PersonComposer['widget_data']['personlist']['person']['quotas'] + $PersonComposer['widget_data']['personlist']['person']['plus_quotas'] - $PersonComposer['widget_data']['personlist']['person']['minus_quotas'] >= 0)}}
				</h5>
