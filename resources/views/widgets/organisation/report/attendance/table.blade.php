...
@if (!$widget_error_count)
	...
	@section('widget_body')
		@if(isset($PersonComposer['widget_data']['personlist']['person']))
			<table class="table table-bordered table-affix">
				<thead>
					<tr>
						<th rowspan="2" class="text-center font-11" style="width:4%">No<br/>&nbsp;</th>
						<th rowspan="2" class="text-left font-11">Nama <br/>(Jabatan)</th>
						<th rowspan="2" class="text-center font-11" style="width:4%">HB<br/>&nbsp;</th>
						<th colspan="4" class="text-center font-11" style="width:16%">HC</th>
						<th colspan="8" class="text-center font-11" style="width:32%">AS</th>
						<th rowspan="2" class="text-center font-11" style="width:6%">Total<br/>&nbsp;</th>
						<th rowspan="2" class="text-center font-11" style="width:8%">Time Loss Rate<br/>&nbsp;</th>
						<th rowspan="2" class="text-center font-11" style="width:8%">&nbsp;</th>
					</tr>
					<tr>
						<th class="text-center font-11" style="width:4%">HT</th>
						<th class="text-center font-11" style="width:4%">HP</th>
						<th class="text-center font-11" style="width:4%">HD</th>
						<th class="text-center font-11" style="width:4%">HC</th>
						<th class="text-center font-11" style="width:4%">DN</th>
						<th class="text-center font-11" style="width:4%">SS</th>
						<th class="text-center font-11" style="width:4%">SL</th>
						<th class="text-center font-11" style="width:4%">CN</th>
						<th class="text-center font-11" style="width:4%">CB</th>
						<th class="text-center font-11" style="width:4%">CI</th>
						<th class="text-center font-11" style="width:4%">UL</th>
						<th class="text-center font-11" style="width:4%">AS</th>
					</tr>
				</thead>
				<tbody>
