        ...
        @endif >
            ...
            <ul class="nav nav-third-level">
                <li @if(isset($person['id'])||(Input::get('person_id'))) class="active" @endif>
                    <a  @if(Input::get('org_id')==$value) @if(Input::get('person_id')) class="active" @endif @endif href="javascript:;"><i class="fa fa-users fa-fw"></i> Data Karyawan <span class="fa arrow"></span></a>
                    <ul class="nav nav-fourty-level">
                            ...
                            <li @if(isset($person['id'])||(Input::get('person_id'))) class="active" @endif>
                                ...
                                <ul class="nav nav-fifty-level">
                                    ...
                                    <li @if(isset($widget_options['sidebar']['active_document_person'])&&Input::get('org_id')==$value) class="active-li" @endif>
                                        <a href="{{ route('hr.person.documents.index', ['org_id' => $value, 'person_id' => $person['id']]) }}" @if(isset($widget_options['sidebar']['active_schedule_person'])&&Input::get('org_id')==$value) class="active" @endif>Dokumen</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
