		...
		<li @if(isset($widget_options['sidebar']['laporan'])) class="active" @endif>
			...
			<ul class="nav nav-third-level">
				<li @if(isset($widget_options['sidebar']['active_report_attendances'])&&Input::get('org_id')==$value) class="active-li" @endif>
					<a href="{{route('hr.report.activities.index', ['org_id' => $value])}}" @if(isset($widget_options['sidebar']['active_report_attendances'])&&Input::get('org_id')==$value) class="active" @endif><i class="fa fa-file-text-o fa-fw"></i> Laporan Aktivitas</a>
				</li>
				<li @if(isset($widget_options['sidebar']['active_report_wages'])&&Input::get('org_id')==$value) class="active-li" @endif>
					<a href="{{route('hr.report.attendances.index', ['org_id' => $value])}}" @if(isset($widget_options['sidebar']['active_report_wages'])&&Input::get('org_id')==$value) class="active" @endif><i class="fa fa-file-text-o fa-fw"></i> Laporan Kehadiran</a>
				</li>
			</ul>
		</li>
	</ul>
