<li @if(Input::has('org_id') && Input::get('org_id')==$value) class="active" @endif>
	<a @if(Input::get('org_id')==$value) class="active" @endif href="#" class="top-level"><i class="fa fa-bank fa-fw"></i> {{ Session::get('user.organisationcodes')[$key] }} <span class="fa arrow"></span></a>
	<ul class="nav nav-second-level">
		...
		<li id="delete_org">
			<a href="#" data-toggle="modal" data-target="#deleteorg" data-delete-action="{{ route('hr.organisations.delete', [$value, 'org_id' => $value]) }}"><i class="fa fa-trash fa-fw"></i> Hapus</a>
		</li>
			...
			<ul class="nav nav-third-level">
				<li @if(Input::get('org_id')==$value) @if(isset($branch['id'])||(Input::has('branch_id'))) class="active" @endif @endif>
					...
					<ul class="nav nav-fourty-level">
						...
						@if (isset($branch['id'])&&($branch['organisation_id']==$value))
							<li @if(isset($branch['id'])||(Input::has('branch_id'))) class="active" @endif>
								...
								<ul class="nav nav-fifty-level">
									...
									<li @if(isset($widget_options['sidebar']['active_finger_branch'])&&Input::get('org_id')==$value) class="active-li" @endif>
									    <a href="{{ route('hr.branch.fingers.index', ['org_id' => $value, 'branch_id' => $branch['id']]) }}">Sidik Jari</a>
									</li> 
								</ul>
							</li>
						@endif
							...
							<li @if(isset($person['id'])||(Input::get('person_id'))) class="active" @endif>
								...
								<ul class="nav nav-fifty-level">
									...
									<li @if(isset($widget_options['sidebar']['active_workleave_person'])&&Input::get('org_id')==$value) class="active-li" @endif>
										<a href="{{ route('hr.person.workleaves.index', ['org_id' => $value, 'person_id' => $person['id']]) }}" @if(isset($widget_options['sidebar']['active_workleave_person'])&&Input::get('org_id')==$value) class="active" @endif>Cuti</a>
									</li>
