@section('nav_topbar')
	...
	['breadcrumb' => [
						...
						['name' => (is_null($id) ? 'Tambah' : 'Ubah'), 'route' => (is_null($id) ? route('hr.branch.apis.create', ['org_id' => $data['id'], 'branch_id' => $branch['id']]) : route('hr.branch.apis.edit', ['id' => $id, 'org_id' => $data['id'], 'branch_id' => $branch['id']]) )]
					]
	])
@stop
